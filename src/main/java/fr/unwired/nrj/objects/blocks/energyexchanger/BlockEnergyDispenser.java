...
public class BlockEnergyDispenser extends BlockBase implements ITileEntityProvider {

	public BlockEnergyDispenser(String name, Material materialIn, float resistance, float hardness) {
		super(name, materialIn, resistance, hardness);
	}

	@Override
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityEnergyDispenser();
	}
